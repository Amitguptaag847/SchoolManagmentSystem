  ...
  <div class="row m-0">
    ...
    <div class="col-2 h-100 px-0 bg-dark left_section">
      ...
      <ul class="nav mt-2 sidebar flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo URLROOT; ?>/admins/editprofile"><i class="fas fa-user-edit"></i> Edit your Profile</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col px-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2 mx-3 mt-2 bg-light">
          <li class="active" aria-current="page"><i class="fas fa-user-edit"></i> Edit your Profile</li>
          <li class="breadcrumb-item ml-auto"><a href="<?php echo URLROOT; ?>/admins/dashboard"><i class="fas fa-home"></i> Home</a></li>
          <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user-edit"></i> Edit your Profile</li>
        </ol>
      </nav>
      ...
      <div class="row m-3">
        <div class="col py-2 bg-light border border-info rounded">
          ...
          <?php flash('changeAdminData'); ?>

          <form class="" action="<?php echo URLROOT; ?>/admins/editprofile" method="post">
            <div class="row">
              <div class="col">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col form-group">
                        <select class="form-control" name="gender"  required>
                          <option value=""  <?php if($data['gender'] == ""){ echo 'selected'; } ?>>Gender</option>
                    ...
                    <div class="row">
                      <div class="col form-group mb-0 input-group">
                        ...
                        <input type="text" name="mobile_number" class="form-control" value="<?= $data['mobile_number']; ?>" placeholder="Mobile Number"  required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-3 border border-info rounded">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col form-group mb-0">
                        <select class="form-control" name="current_country" required>
              ...
              <div class="col">
                    ...
                    <div class="card border border-info rounded">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col form-group mb-0">
                            <select class="form-control" name="permanent_country" required>
                              <option value="india">India</option>
                            </select>
                          </div>
                          <div class="col form-group mb-0">
                ...
                <div class="row">
                  <div class="col-6 form-group">
                    <input type="submit" name="save" class="btn btn-block btn-primary" value="Save">
                  </div>
                  <div class="col-6 form-group">
                    <a href="<?= URLROOT; ?>/admins/editprofile" class="btn btn-secondary btn-block">Reset</a>
                  </div>
                </div>
