...
?>
<link rel="stylesheet" href="<?php echo URLROOT ?>/css/viewstudentprofile.css">
  ...
  <div class="row m-0">
    ...
    <div class="col-2 h-100 px-0 bg-dark left_section">
      ...
      <ul class="nav mt-2 sidebar flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo URLROOT; ?>/admins/viewstudentprofile"><i class="fas fa-user-graduate"></i> View Student Profile</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col px-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2 mx-3 mt-2 bg-light">
          <li class="active" aria-current="page"><i class="fas fa-user-graduate"></i> View Student Profile</li>
          <li class="breadcrumb-item ml-auto"><a href="<?php echo URLROOT; ?>/admins/dashboard"><i class="fas fa-home"></i> Home</a></li>
          <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user-graduate"></i> View Student Profile</li>
        </ol>
      </nav>
          ...
          <table class="table table-striped table-secondary table-hover">
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <td><a href="<?= URLROOT; ?>/admins/editstudentprofile/<?= $value->user_id; ?>" class="text-primary"><i class="fas fa-pencil-alt"></i> Edit</a></td>
                <td><a href="<?= URLROOT; ?>/admins/viewstudentprofile/<?= $value->user_id; ?>" class="text-success"><i class="fas fa-eye"></i> View</a></td>
              </tr>
            <?php endforeach; ?>
            </tbody>
          </table>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col form-group mb-0 input-group">
                        ...
                        <input type="text" name="username" class="form-control" value="<?= $data['username']; ?>" placeholder="Username" disabled required>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                ...
                <div class="row">
                  <div class="col-6 form-group">
                    <a href="<?= URLROOT; ?>/admins/editstudentprofile/<?= $data['student_id']; ?>" class="btn btn-primary btn-block">Edit</a>
                  </div>
                  <div class="col-6 form-group">
                    <a href="<?= URLROOT; ?>/admins/viewstudentprofile" class="btn btn-secondary btn-block">Search Again</a>
                  </div>
                </div>
