  ...
  <div class="row m-0">
    ...
    <div class="col-2 h-100 px-0 bg-dark left_section">
      ...
      <ul class="nav mt-2 sidebar flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo URLROOT; ?>/admins/maintainattendance"><i class="far fa-calendar-alt"></i> Maintain Attendance</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col px-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2 mx-3 mt-2 bg-light">
          <li class="active" aria-current="page"><i class="far fa-calendar-alt"></i> Maintain Attendance</li>
          <li class="breadcrumb-item ml-auto"><a href="<?php echo URLROOT; ?>/admins/dashboard"><i class="fas fa-home"></i> Home</a></li>
          <li class="breadcrumb-item active" aria-current="page"><i class="far fa-calendar-alt"></i> Maintain Attendance</li>
        </ol>
      </nav>
