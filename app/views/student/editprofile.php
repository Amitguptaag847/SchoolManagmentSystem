              ...
              <div class="col">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col form-group">
                        <input type="text" name="student_first_name" class="form-control" value="" placeholder="First Name" required>
                      </div>
                      <div class="col form-group">
                        <input type="text" name="student_last_name" class="form-control" value="" placeholder="Last Name" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                    ...
                    <div class="row">
                      <div class="col form-group  mb-0">
                        <input type="email" name="student_email" class="form-control" value="" placeholder="Email" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-3 border border-info rounded">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col form-group">
                        <input type="text" name="student_current_address" class="form-control" value="" placeholder="Address" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group mb-0">
                        <input type="date" name="student_current_city" class="form-control" value="" placeholder="City" required>
                      </div>
                      <div class="col form-group mb-0">
                        <select class="form-control" name="student_current_country">
                          <option value="india">India</option>
                        </select>
                      </div>
                      <div class="col form-group mb-0">
                        <input type="text" name="student_current_pincode" class="form-control" value="" placeholder="Pincode" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-3 border border-info rounded">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col form-group">
                        <input type="text" name="student_permanent_address" class="form-control" value="" placeholder="Address" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group mb-0">
                        <input type="date" name="student_permanent_city" class="form-control" value="" placeholder="City" required>
                      </div>
                      <div class="col form-group mb-0">
                        <select class="form-control" name="student_permanent_country">
                          <option value="india">India</option>
                        </select>
                      </div>
                      <div class="col form-group mb-0">
                        <input type="text" name="student_permanent_pincode" class="form-control" value="" placeholder="Pincode" required>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                  ...
                  <div class="col">
                    <div class="card border border-info rounded">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="fathers_name" class="form-control" value="" placeholder="Father's name" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="mothers_name" class="form-control" value="" placeholder="Mother's name" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="fathers_occupation" class="form-control" value="" placeholder="Father's occupation" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="mothers_occupation" class="form-control" value="" placeholder="Mothers's occupation" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="family_annual_income" class="form-control" value="" placeholder="Annual income of family" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <input type="text" name="fathers_mobile_number" class="form-control" value="" placeholder="Fathers Contact Number" required>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-6 form-group">
                    <input type="submit" name="save" class="form-control btn btn-primary btn-block" value="Save">
                  </div>
                </div>
              </div>
            </div>
